...
public class HomeCategoryItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<CategoryDataItem> listUpcoming;
    ...
    public HomeCategoryItemAdapter(Activity activity, RecyclerView view, List<CategoryDataItem> items, int width, int height) {
    ...
    public void setItems(List<CategoryDataItem> items) {
        this.listUpcoming = items;
        notifyDataSetChanged();
    }


    public void insertData(List<CategoryDataItem> items) {
        setLoaded();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            final CategoryDataItem c = listUpcoming.get(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, CategoryDataItem obj, int position);
    }
