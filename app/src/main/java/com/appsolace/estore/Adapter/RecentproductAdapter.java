...
import com.appsolace.estore.Actvity.ActivityRecentlyProductDetails;
...
public class RecentproductAdapter extends RecyclerView.Adapter<RecentproductAdapter.MyViewHolder> {
    ...
    private List<RecentlyProductItem> newProductsList;
    ...
    public RecentproductAdapter(Activity activity, List<RecentlyProductItem> newProductsList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final RecentlyProductItem newProductItem = newProductsList.get(position);
        ...
        holder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity, ActivityRecentlyProductDetails.class);
                intent.putExtra("RecentProductItem", newProductItem);
