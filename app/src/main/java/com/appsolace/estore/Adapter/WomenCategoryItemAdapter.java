...
public class WomenCategoryItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<Menu2CategoryItem> listUpcoming;
    ...
    public WomenCategoryItemAdapter(Activity activity, RecyclerView view, List<Menu2CategoryItem> items, int width, int height) {
    ...
    public void setItems(List<Menu2CategoryItem> items) {
        this.listUpcoming = items;
        notifyDataSetChanged();
    }


    public void insertData(List<Menu2CategoryItem> items) {
        setLoaded();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            final Menu2CategoryItem c = listUpcoming.get(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Menu2CategoryItem obj, int position);
    }
