...
public class CategoryProductItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CategoryProductItemAdapter(Activity activity, RecyclerView view, List<ProductItem> items, int width, int height) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            vItem.product_price.setText(sPref.getString("CUR", "") + " " + c.getProductPrice());
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        CustomTextView product_name, product_price;
