...
public class HomeViewPagerAdapter extends PagerAdapter {
    ...
    Context context;
    String Image_path;
    List<HomeSliderImageItem> banner;
    LayoutInflater inflater;

    public HomeViewPagerAdapter(Context context, List<HomeSliderImageItem> banner) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        HomeSliderImageItem imageItem = banner.get(position);
