package com.appsolace.estore.customanimation;
...
public class ArcConfiguration
{
   ...
   /* private int mColors[] = {Color.parseColor("#F90101"), // RED
    ...
    private int mColors[] = {Color.parseColor("#18bdff"), // RED
            Color.parseColor("#18bdff"), // BLUE
            Color.parseColor("#18bdff"), // YELLOW
            Color.parseColor("#18bdff")};// GREEN
