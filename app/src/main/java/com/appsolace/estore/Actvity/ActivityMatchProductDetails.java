...
public class ActivityMatchProductDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private MatchProductItem ProductItem;
    List<com.appsolace.estore.Model.MatchWithProduct.ProductSizeItem> productSizeItemList;
    List<com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem> productAttributeItemList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductItem = (MatchProductItem) intent.getSerializableExtra("MatchProductItem");

        sPref = PreferenceManager.getDefaultSharedPreferences(ActivityMatchProductDetails.this);
        initdata();


        if (Common.isNetworkAvailable(ActivityMatchProductDetails.this)) {
    ...
    private void GetRetriverd() {
        ...
        Dialog dialog = new DialogUtils(ActivityMatchProductDetails.this).buildDialogInternate(new CallbackInternate() {
            @Override
    ...
    public void initdata() {
        ...
        ProgressDialog = new Dialog(ActivityMatchProductDetails.this, android.R.style.Theme_Translucent_NoTitleBar);
        ProgressDialog.setContentView(R.layout.progressbar);
        ProgressDialog.setCancelable(false);

        //Adapter for Home_Slider
        MatchProductViewPagerAdapter mCustomPagerAdapter = new MatchProductViewPagerAdapter(ActivityMatchProductDetails.this, ProductItem.getProductImage());
        ...
        if (productSizeItemList != null && productSizeItemList.size() > 0) {
            ...
            for (int i = 0; i < productSizeItemList.size(); i++) {
                com.appsolace.estore.Model.MatchWithProduct.ProductSizeItem productSizeItem = productSizeItemList.get(i);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ly_sizeview:
                Dialog dialog = new DialogUtils(ActivityMatchProductDetails.this).buildDialogMatchSizeColor(new ProductSizeCallbackMessage() {
                    @Override
            ...
            case R.id.txt_addtocart:
                ...
                if (productSizeItemList != null && productSizeItemList.size() > 0) {
                    if (str_sizeid.equals("") && str_colorcode.equals("")) {
                        Dialog dialog1 = new DialogUtils(ActivityMatchProductDetails.this).buildDialogMessage(new CallbackMessage() {
                            @Override
                            public void onSuccess(Dialog dialog) {
                                dialog.dismiss();
                            }
            ...
            case R.id.layout_cart:
                ...
                Intent main = new Intent(ActivityMatchProductDetails.this,MainActivity.class);
    ...
    public void setAttributeView(List<com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem> productAttributeItemList) {
        ...
        for (int i = 0; i < productAttributeItemList.size(); i++) {
            ...
            com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem productAttributeItem = productAttributeItemList.get(i);
        ...
        callBooking.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (resp != null) {
                    if (resp.get("status").getAsString().equals("success")) {
                        ...
                        if (Isactive == 0) {
                            Common.AccountLock(ActivityMatchProductDetails.this);
                        }
                        else if (resp.has("message") && !resp.get("message").isJsonNull()) {
                            Common.Errordialog(ActivityMatchProductDetails.this,resp.get("message").toString());
                        }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                ...
                if (t instanceof SocketTimeoutException) {
                    ...
                    Common.ShowHttpErrorMessage(ActivityMatchProductDetails.this, message);
                }
            }
        });
    }
    ...
    public void displayForMatchView(List<MatchProductItem> matchProductItemList) {
        ...
        RecyclerView.LayoutManager horizontalLayoutManagaer = new LinearLayoutManager(ActivityMatchProductDetails.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        if (matchProductItemList != null && matchProductItemList.size() > 0) {
            ...
            MatchWithproductAdapter newproduct_adpter = new MatchWithproductAdapter(ActivityMatchProductDetails.this, matchProductItemList);
    ...
    public void displayForRecentlyView(List<RecentlyProductItem> recentlyProductItemList) {
        ...
        if (recentlyProductItemList != null && recentlyProductItemList.size() > 0) {
            //Adapter for New Products
            RecentproductAdapter newproduct_adpter = new RecentproductAdapter(ActivityMatchProductDetails.this, recentlyProductItemList);
    ...
    public class MatchProductViewPagerAdapter extends PagerAdapter {
        // Declare Variables
        Context context;
        String Image_path;
        List<com.appsolace.estore.Model.MatchWithProduct.ProductImageItem> banner;
        // ViewHolder holder;
        LayoutInflater inflater;

        // int positiondata;

        public MatchProductViewPagerAdapter(Context context, List<com.appsolace.estore.Model.MatchWithProduct.ProductImageItem> banner) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            com.appsolace.estore.Model.MatchWithProduct.ProductImageItem imageItem = banner.get(position);
            ...
            pager_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, MatchProductImagepager.class);
                    i.putExtra("MatchProductItem", ProductItem);
                ...
                if (resp != null) {
                    if (resp.get("status").getAsString().equals("success")) {
                        ...
                        if (resp.has("message") && !resp.get("message").isJsonNull()) {
                            ...
                            Toast.makeText(ActivityMatchProductDetails.this, Message, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    if (jsonObject != null && jsonObject.get("status").getAsString().equals("success")) {
                      ...
                      /*  {"status":"false","stock_flag":0,"Isactive":"1"}*/
                        ...
                        if (Isactive == 0) {
                            ...
                            Common.Errordialog(ActivityMatchProductDetails.this,jsonObject.get("message").toString());
                        }
    ...
    private void ErrorMessage(String Message) {
        // Common.showInternetInfo(ActivitySignIn.this, "Network is not available");
        Dialog dialog = new DialogUtils(ActivityMatchProductDetails.this).buildDialogMessage(new CallbackMessage() {
            @Override
            public void onSuccess(Dialog dialog) {
                dialog.dismiss();
            }
