...
import com.appsolace.estore.Utili.TouchImageView;
...
public class MatchProductImagepager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sPref = PreferenceManager.getDefaultSharedPreferences(MatchProductImagepager.this);
    ...
    private void initdata() {
        ...
        ProductViewPager mCustomPagerAdapter = new ProductViewPager(MatchProductImagepager.this, productItem.getProductImage());
    ...
    public class ProductViewPager extends PagerAdapter {
        ...
        public ProductViewPager(Context context, List<com.appsolace.estore.Model.MatchWithProduct.ProductImageItem> banner) {
