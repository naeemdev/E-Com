...
public class ActivityProductDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    List<com.appsolace.estore.Model.ProductListModel.ProductSizeItem> productSizeItemList;
    List<com.appsolace.estore.Model.ProductListModel.ProductAttributeItem> productAttributeItemList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sPref = PreferenceManager.getDefaultSharedPreferences(ActivityProductDetails.this);
        initdata();

        if (Common.isNetworkAvailable(ActivityProductDetails.this)) {
    ...
    private void GetRetriverd() {
        ...
        Dialog dialog = new DialogUtils(ActivityProductDetails.this).buildDialogInternate(new CallbackInternate() {
            @Override
    ...
    public void initdata() {
        ...
        ProgressDialog = new Dialog(ActivityProductDetails.this, android.R.style.Theme_Translucent_NoTitleBar);
        ProgressDialog.setContentView(R.layout.progressbar);
        ProgressDialog.setCancelable(false);

        //Adapter for Home_Slider
        ProductViewPagerAdapter mCustomPagerAdapter = new ProductViewPagerAdapter(ActivityProductDetails.this, productItem.getProductImage());
        ...
        if (productSizeItemList != null && productSizeItemList.size() > 0) {
            ...
            for (int i = 0; i < productSizeItemList.size(); i++) {
                com.appsolace.estore.Model.ProductListModel.ProductSizeItem productSizeItem = productSizeItemList.get(i);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ly_back:
                ...
                hsid2.putInt("ProductFilter", 2);
                hsid2.commit();
                finish();
                break;

            case R.id.ly_sizeview:
                Dialog dialog = new DialogUtils(ActivityProductDetails.this).buildDialogProdSizeColor(new ProductSizeCallbackMessage() {
                    @Override
            ...
            case R.id.txt_addtocart:
                ...
                if (productSizeItemList != null && productSizeItemList.size() > 0) {
                    if (str_sizeid.equals("") && str_colorcode.equals("")) {
                        Dialog dialog1 = new DialogUtils(ActivityProductDetails.this).buildDialogMessage(new CallbackMessage() {
                            @Override
                            public void onSuccess(Dialog dialog) {
                                dialog.dismiss();
                            }
            ...
            case R.id.layout_cart:
                ...
                Intent main = new Intent(ActivityProductDetails.this,MainActivity.class);
    ...
    public void setAttributeView(List<com.appsolace.estore.Model.ProductListModel.ProductAttributeItem> productAttributeItemList) {
        ...
        for (int i = 0; i < productAttributeItemList.size(); i++) {
            ...
            com.appsolace.estore.Model.ProductListModel.ProductAttributeItem productAttributeItem = productAttributeItemList.get(i);
        ...
        callBooking.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (resp != null) {
                    if (resp.get("status").getAsString().equals("success")) {
                        ...
                        if (match_product_detail != null && match_product_detail.size() > 0) {
                            ...
                            for (int i = 0; i < match_product_detail.size(); i++) {
                                ...
                                if (product_size != null && product_size.size() > 0) {
                                    ...
                                    List<com.appsolace.estore.Model.MatchWithProduct.ProductSizeItem> list_ProductSizeItem = new ArrayList<>();

                                    for (int j = 0; j < product_size.size(); j++) {

                                        JsonObject jsonObject_product_size = product_size.get(j).getAsJsonObject();

                                        com.appsolace.estore.Model.MatchWithProduct.ProductSizeItem productSizeItem = new com.appsolace.estore.Model.MatchWithProduct.ProductSizeItem();
                                ...
                                if (product_attribute != null && product_attribute.size() > 0) {
                                    ...
                                    List<com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem> list_ProductAttributeItem = new ArrayList<>();

                                    for (int j = 0; j < product_attribute.size(); j++) {

                                        JsonObject jsonObject_product_attribute = product_attribute.get(j).getAsJsonObject();

                                        com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem productAttributeItem = new com.appsolace.estore.Model.MatchWithProduct.ProductAttributeItem();
                        ...
                        if (Isactive == 0) {
                            Common.AccountLock(ActivityProductDetails.this);
                        }
                        else if (resp.has("message") && !resp.get("message").isJsonNull()) {
                            Common.Errordialog(ActivityProductDetails.this,resp.get("message").toString());
                        }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                ...
                if (t instanceof SocketTimeoutException) {
                    ...
                    Common.ShowHttpErrorMessage(ActivityProductDetails.this, message);
                }
            }
        });
    }
    ...
    public void displayForMatchView(List<MatchProductItem> matchProductItemList) {
        ...
        RecyclerView.LayoutManager horizontalLayoutManagaer = new LinearLayoutManager(ActivityProductDetails.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        if (matchProductItemList != null && matchProductItemList.size() > 0) {
            ...
            MatchWithproductAdapter newproduct_adpter = new MatchWithproductAdapter(ActivityProductDetails.this, matchProductItemList);
    ...
    public void displayForRecentlyView(List<RecentlyProductItem> recentlyProductItemList) {
        ...
        if (recentlyProductItemList != null && recentlyProductItemList.size() > 0) {
            //Adapter for New Products
            RecentproductAdapter newproduct_adpter = new RecentproductAdapter(ActivityProductDetails.this, recentlyProductItemList);
        ...
        callBooking.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (resp != null) {
                    ...
                    /*{"message":"remove successfully","status":"success","Isactive":"1","total_favorite":"15"}*/
                    ...
                    if (resp.get("status").getAsString().equals("success")) {
                        ...
                        if (resp.has("message") && !resp.get("message").isJsonNull()) {
                            ...
                            Toast.makeText(ActivityProductDetails.this, Message, Toast.LENGTH_SHORT).show();
                        }
    ...
    public class ProductViewPagerAdapter extends PagerAdapter {
        ...
        Context context;
        String Image_path;
        List<com.appsolace.estore.Model.ProductListModel.ProductImageItem> banner;
        // ViewHolder holder;
        LayoutInflater inflater;

        // int positiondata;

        public ProductViewPagerAdapter(Context context, List<com.appsolace.estore.Model.ProductListModel.ProductImageItem> banner) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            final com.appsolace.estore.Model.ProductListModel.ProductImageItem imageItem = banner.get(position);
            ...
            pager_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, ProductImagepager.class);
                    i.putExtra("ProductItem", productItem);
                    ...
                    if (jsonObject != null && jsonObject.get("status").getAsString().equals("success")) {
                      ...
                      /*  {"status":"false","stock_flag":0,"Isactive":"1"}*/
                        ...
                        if (Isactive == 0) {
                            ...
                            Common.Errordialog(ActivityProductDetails.this,jsonObject.get("message").toString());
                        }
    ...
    private void ErrorMessage(String Message) {
        // Common.showInternetInfo(ActivitySignIn.this, "Network is not available");
        Dialog dialog = new DialogUtils(ActivityProductDetails.this).buildDialogMessage(new CallbackMessage() {
            @Override
            public void onSuccess(Dialog dialog) {
                dialog.dismiss();
            }
