...
public class ProductImagepager extends AppCompatActivity {
    ...
    public class ProductViewPager extends PagerAdapter {
        ...
        public ProductViewPager(Context context, List<com.appsolace.estore.Model.ProductListModel.ProductImageItem> banner) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            com.appsolace.estore.Model.ProductListModel.ProductImageItem imageItem = banner.get(position);
